  ...
  return (
    <section className="color lg:py-[140px] md:py-[100px] py-20">
      <div className="container lg:text-center text-left">
        <h2 className="text-white font-bold text-[36px] leading-[56px] md:text-[54px] md:leading-[100%] lg:text-[72px] lg:leading-[100%] tracking-[-0.02em] md:pr-56 sm:pr-0">
          Your work, everywhere you are
        </h2>
        
        <p className="text-white mt-6 md:pr-56 sm:pr-0">
